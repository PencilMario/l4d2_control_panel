...
- [ ] Task 1: Extract and verify the canonical journaled workspace replacement helper.
- [ ] Task 2: Implement and verify secure private ZIP export/import in the content layer.
