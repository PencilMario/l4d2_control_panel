...
CREATE TABLE IF NOT EXISTS instances (
 ...
 package_version TEXT NOT NULL DEFAULT '', selected_package_id TEXT NOT NULL DEFAULT '', package_source_id TEXT NOT NULL DEFAULT '', package_source_repository TEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS jobs (
 ...
 error TEXT NOT NULL DEFAULT '', timeout_minutes INTEGER NOT NULL DEFAULT 1440, created_at TEXT NOT NULL, updated_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS scheduled_tasks (
 ...
 enabled INTEGER NOT NULL, timeout_minutes INTEGER NOT NULL DEFAULT 1440, last_run TEXT NOT NULL DEFAULT '', next_run TEXT NOT NULL DEFAULT ''
);
...
CREATE TABLE IF NOT EXISTS shared_vpk_restarts (
 instance_id TEXT PRIMARY KEY, container_id TEXT NOT NULL, publication_id TEXT NOT NULL, job_id TEXT NOT NULL DEFAULT '',
